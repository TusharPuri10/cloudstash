...
const AuthCard = () => {
  return (
    <div className="absolute inset-0 z-50 mx-auto w-1/2 h-1/2 mt-24 rounded-xl auth-card flex flex-col items-center justify-center" style={{backgroundColor: "#132E35"}}>
