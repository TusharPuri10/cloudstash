    ...
    <div className="relative z-0 w-full h-screen">
      ...
      <Head>
        ...
        <div className="absolute inset-0 z-50 h-20">
          <h1 className="flex justify-center items-center pt-4 mt-8 mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">A cloud-based storage service</h1>
