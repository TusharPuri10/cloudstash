...
export default function App() {
      ...
      await axios
        ...
        .then((res) => {
          if (res.data) {
            ...
            setMessage({ text: "Nothing shared with you yet!", open: true, type: "error" });
            setTimeout(() => {
  ...
  return (
    <div className="bg-[#0D1F23]">
      ...
      <Topbar />
      <div className="mx-6 rounded-xl bg-[#132E35] h-[calc(100vh-80px)]">
        ...
        {loading ? (
          ...
          <div>
          <div
            className={card.shown ? "opacity-30 flex" : "flex"}
            onClick={() =>
              card.shown &&
              setCard({
                name: "",
          ...
          >
            ...
            >
              ...
              {/* Side Bar */}
              <div className="md:w-1/12 w-1/6 h-68">
            ...
            {message.open && (message.text === "You have reached the limit" || message.text === "User not found" || message.text==="File shared") && (
              <div
                id="toast-simple"
                ...
                role="alert"
              >
                  {message.type==="error" && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-red-700">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
                  </svg>}
                  {message.type==="success" && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-green-600">
