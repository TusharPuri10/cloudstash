    ...
    <div className="relative z-0 w-full h-screen">
      ...
      <Head>
        ...
        <div className=" inset-y-0 absolute z-50 h-20">
          ...
          <p className="pt-4 flex justify-center items-center text-lg font-normal text-white lg:text-xl space-x-6">
            <a href="https://github.com/TusharPuri10" target="_blank"><img className="rounded-full w-10 h-10 hover:opacity-75" src="/github.png" alt="" /></a>
