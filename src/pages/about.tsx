    ...
    <div style={{backgroundColor: "#0D1F23" }}>
      ...
      <div className="pt-10 text-center">
        ...
        <h1 className="pt-10 px-4 mb-4 text-xl font-extrabold text-gray-900 dark:text-white md:text-xl lg:text-2xl">
          A cutting-edge cloud storage solution built with
          the latest technologies. Our platform is designed to provide users with
          a seamless and secure experience for managing and sharing their digital
          assets.
        </h1>
      </div>
      ...
      <div className="max-w-3xl mx-auto mt-8 p-4">
        <section className="mb-8">
          ...
          CloudStash is a cutting-edge cloud storage solution designed to revolutionize the way you manage and share digital assets. CloudStash leverages the power of React Three Fiber, Next.js, TypeScript, and AWS S3 to provide users with a seamless and secure cloud storage experience.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className='text-white'>
            At CloudStash, we are on a mission to simplify and enhance the way individuals and businesses interact with their data. Our goal is to empower users with a reliable and feature-rich cloud storage service.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-white">
            <li>
              <strong>React Three Fiber Integration:</strong> Leverage the power of React Three Fiber for a visually stunning and intuitive user interface.
            </li>
            <li>
              <strong>Next.js for Scalability:</strong> Built on Next.js, our platform is optimized for performance and scalability.
            </li>
            <li>
              <strong>TypeScript for Robust Code:</strong> We believe in clean and maintainable code, and TypeScript ensures a robust codebase.
            </li>
            <li>
              <strong>AWS S3 Integration:</strong> Benefit from secure and reliable cloud storage with our integration with Amazon S3.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8 text-white">
          ...
          <p>
            Ready to experience the future of cloud storage? Sign up for CloudStash today and discover a new level of convenience, security, and innovation. Thank you for choosing CloudStash for all your storage needs. We're excited to have you on board!
          </p>
        </section>
      </div>
    </div>
